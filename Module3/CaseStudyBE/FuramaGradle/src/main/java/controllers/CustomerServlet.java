...
public class CustomerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "detailCustomer":
                ...
                break;
            case "searchCustomer":
                searchCustomerGet(request, response);
                break;
            default:
                redirectCustomer(request, response);
                break;
    ...
    private void addCustomerPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            setDataCustomer(request, customer);
    ...
    private void searchCustomerGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        try {
            String customerName = request.getParameter("customerName");
            List<Customer> listCustomer = this.customerService.findInService(customerName);
    ...
    private void setDataCustomer(HttpServletRequest request, Customer customer) {
