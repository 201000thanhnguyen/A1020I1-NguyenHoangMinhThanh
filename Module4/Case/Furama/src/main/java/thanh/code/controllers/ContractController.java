...
public class ContractController {
    ...
    public ContractController(IContractService contractService, IEmployeeService employeeService,
                              ...
                              IContractDetailService contractDetailService, IAttachServiceService attachServiceService, IServiceTypeService serviceTypeService) {
...
//            contractDetail.setAttachService(this.attachServiceService.listEntity().get(0));
//            contractDetail.setContractDetailQuantity(0);
